...
public class CifsOnlyXMLServerConfiguration extends ServerConfiguration {
        ...
        if (authElem != null) {
            ...
            if (classElem == null) {
                ...
                if (authType.equalsIgnoreCase("local")) {
                    ...
                    //authClass = "com.surfs.nas.mnt.SurAuthenticator";
    ...
    protected final void procHostElement(Element host, CIFSConfigSection cifsConfig)
        ...
        elem = findChildNode("disableNIO", host.getChildNodes());
        if (elem != null) {
            ...
            for (int i = 0; i < mapElems.getLength(); i++) {
                ...
                if (node.getNodeType() == ELEMENT_TYPE) {
                    ...
                    if (elem.getNodeName().equals("mapDrive")) {
                        ...
                        StringBuilder remPath = new StringBuilder();
                        remPath.append("\\\\");
     ...
     * @exception InvalidConfigurationException
     */
    public final void addDiskShare(Element disk, FilesystemsConfigSection filesysConfig)
            throws InvalidConfigurationException {
