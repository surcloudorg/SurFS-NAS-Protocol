...
public class ByteBufferPool {
    ...
    /**
     * Allocate a byte buffer from the appropriate buffer list, if there are
     * buffers available then do not wait
     *
     * @param siz int
     * @return byte[]
     */
    ...
    public final void shrinkLists() {
        for (ByteBufferList m_bufferList : m_bufferLists) {
            m_bufferList.shrinkList();
        }
    }
    ...
    public String toString() {
        ...
        for (ByteBufferList m_bufferList : m_bufferLists) {
            str.append(m_bufferList.toString());
            str.append(" ");
        }
        str.append("]");
        return str.toString();
