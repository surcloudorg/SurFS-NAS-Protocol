...
public class DiskDeviceContext extends DeviceContext {
    ...
    private String filesystemType = FileSystem.TypeNTFS;
     ...
     * FileSystem.TypeNTFS.
     *
     * Defaults to FileSystem.FAT but will be overridden if the filesystem
     * driver implements the NTFSStreamsInterface.
     *
     * @return String
     */
