...
public class TreeConnection {
    ...
    private final SharedDevice m_shareDev;
     ...
     * @return int
     * @throws org.alfresco.jlan.server.filesys.TooManyFilesException
     */
    public synchronized final int addFile(NetworkFile file, SrvSession sess) throws TooManyFilesException {
    ...
    public final boolean hasReadAccess() {
        return m_permission == FileAccess.ReadOnly || m_permission == FileAccess.Writeable;
    }
    ...
    public final boolean hasWriteAccess() {
        return m_permission == FileAccess.Writeable;
    }
