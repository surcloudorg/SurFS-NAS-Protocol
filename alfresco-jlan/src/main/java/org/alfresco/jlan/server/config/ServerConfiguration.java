 ...
 *
 * <p>
 * Provides the configuration parameters for the network file servers (SMB/CIFS,
 * FTP and NFS).
 *
 * @author gkspencer
 */
public class ServerConfiguration {
    ...
    /**
     * Notify all registered configuration change listeners of a configuration
     * change
     *
     * @param id int
     * @param newVal Object
    ...
    /**
     * Load the configuration from the specified location. The location depends
     * on the implementation of the configuration.
     *
    ...
    /**
     * Save the configuration to the specified location. The location depends on
