...
public class DCEBuffer {
    ...
    public final boolean isFirstFragment() {
        return (getHeaderValue(HDR_FLAGS) & FLG_FIRSTFRAG) != 0;
    }
    ...
    public final boolean isLastFragment() {
        return (getHeaderValue(HDR_FLAGS) & FLG_LASTFRAG) != 0;
    }
    ...
    public final boolean isOnlyFragment() {
        return (getHeaderValue(HDR_FLAGS) & FLG_ONLYFRAG) == FLG_ONLYFRAG;
    }
    ...
    public final boolean hasMoreEntries() {
        return getStatusCode() == SMBStatus.Win32MoreEntries;
    }
    ...
    public final boolean hasSuccessStatus() {
        return getStatusCode() == SMBStatus.NTSuccess;
    }
     ...
     * @param ext int
     */
    private void extendBuffer(int ext) {
     ...
     * @param align int
     */
    private void alignPosition(int align) {
     ...
     * @param align int
     */
    private void alignRxPosition(int align) {
        //	Range check the alignment
