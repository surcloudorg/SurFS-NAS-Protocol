...
public class SMBSrvPacket {
    ...
    public final boolean checkAndXPacketIsValid(
        ...
        return !(getAndXParameterCount(off) < reqWords || getAndXByteCount(off) < reqBytes);
    }
    ...
    public final boolean checkPacketIsValid(int reqWords, int reqBytes) {
        ...
        return !(getParameterCount() < reqWords || getByteCount() < reqBytes);
    }
    ...
    public final boolean checkPacketSignature() {
        ...
        return m_smbbuf[SIGNATURE] == (byte) 0xFF
                && m_smbbuf[SIGNATURE + 1] == 'S'
                && m_smbbuf[SIGNATURE + 2] == 'M'
                && m_smbbuf[SIGNATURE + 3] == 'B';
    }
    ...
    public final boolean isSMB2() {
        ...
        //  Not an SMB2 packet       
        return m_smbbuf[SIGNATURE] == (byte) 0xFE
                && m_smbbuf[SIGNATURE + 1] == 'S'
                && m_smbbuf[SIGNATURE + 2] == 'M'
                && m_smbbuf[SIGNATURE + 3] == 'B';
    }
    ...
    public final boolean isUnicode() {
        return (getFlags2() & FLG2_UNICODE) != 0;
    }
    ...
    public final boolean isCaseless() {
        return (getFlags() & FLG_CASELESS) != 0;
    }
    ...
    public final boolean isLongFileNames() {
        return (getFlags2() & FLG2_LONGFILENAMES) != 0;
    }
    ...
    public final boolean isLongErrorCode() {
        return (getFlags2() & FLG2_LONGERRORCODE) != 0;
    }
