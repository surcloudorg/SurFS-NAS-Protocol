...
public class DCEPipeType {
    ...
    //	IPC$ pipe UUIDs
    private static final UUID _uuidNetLogon = new UUID("8a885d04-1ceb-11c9-9fe8-08002b104860", 2);
    private static final UUID _uuidWinReg = new UUID("338cd001-2244-31f1-aaaa-900038001003", 1);
    private static final UUID _uuidSvcCtl = new UUID("367abb81-9844-35f1-ad32-98f038001003", 2);
    private static final UUID _uuidLsaRpc = new UUID("12345678-1234-abcd-ef00-0123456789ab", 0);
    private static final UUID _uuidSrvSvc = new UUID("4b324fc8-1670-01d3-1278-5a47bf6ee188", 3);
    private static final UUID _uuidWksSvc = new UUID("6bffd098-a112-3610-9833-46c3f87e345a", 1);
    private static final UUID _uuidSamr = new UUID("12345778-1234-abcd-ef00-0123456789ac", 1);
    private static final UUID _uuidSpoolss = new UUID("12345778-1234-abcd-ef00-0123456789ab", 1);
    private static final UUID _uuidSvcctl = new UUID("367abb81-9844-35f1-ad32-98f038001003", 2);
    private static final UUID _uuidEventLog = new UUID("82273FDC-E32A-18C3-3F78-827929DC23EA", 0);
    private static final UUID _uuidNetLogon1 = new UUID("12345678-1234-abcd-ef00-01234567cffb", 1);
