...
//	Primary and secondary protocols to try connection on
     ...
     * name.
     *
     * @param workdir Working directory string, relative to the root of the
     * share.
    ...
    /**
     * Set the remote user name string. The name may be in the format 'user',
