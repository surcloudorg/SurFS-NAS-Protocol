 ...
 *
 * <p>
 * Contains constants used by the LockingAndX SMB/CIFS request, plus methods for
...
public class LockingAndX {
    ...
    /**
     * Check if this is a normal lock/unlock, ie. no flags except the LargeFiles
     * flag may be set
     *
     * @param flags
     * @return boolean
