 ...
 *
 * <p>
 * Contains definitions of the available SMB/CIFS request types, plus SMB
 * transaction/transaction2 request types, remote admin protocol (RAP) requests
 * and NT transaction request types.
 *
 * <p>
 * There are also static methods for converting an SMB command type, transaction
 * type or NT transaction type to a name.
 *
 * @author gkspencer
 */
public class PacketType {
    ...
    private static final String[] _cmdNames2 = {"TreeConnect",
        "TreeDisconnect",
        "Negotiate",
        "SessionSetupAndX",
        "LogoffAndX",
    ...
    private static final String[] _cmdNames3 = {"DiskInformation",
        "Search",
        "Find",
        "FindUnique"
    };

    private static final String[] _cmdNames4 = {"NTTransact",
        "NTTransactSecondary",
        "NTCreateAndX",
        null,
        "NTCancel"
    ...
    private static final String[] _cmdNames5 = {"OpenPrintFile",
        "WritePrintFile",
        "ClosePrintFile",
        "GetPrintQueue"
    };

    private static final String[] _cmdNames6 = {"SendMessage",
        "SendBroadcast",
        "SendForward",
        "CancelForward",
        "GetMachineName",
    ...
    private static final String[] _transNames = {"Trans2Open",
        "Trans2FindFirst",
        "Trans2FindNext",
        "Trans2QueryFileSys",
        "Trans2QueryPath",
    ...
    private static final String[] _ntTranNames = {"", //	zero not used
        "NTTransCreate",
        "NTTransIOCtl",
