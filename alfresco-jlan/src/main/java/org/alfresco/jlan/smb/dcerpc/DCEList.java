...
public abstract class DCEList {
    ...
    private List m_dceObjects;

    /**
     * Default constructor
     */
    protected DCEList() {
        m_dceObjects = new ArrayList();
    }
    ...
    public final void writeList(DCEBuffer buf)
        ...
        if (m_dceObjects != null) {
            ...
            for (Object m_dceObject : m_dceObjects) {
                //	Get an object from the list
                DCEWriteable object = (DCEWriteable) m_dceObject;
