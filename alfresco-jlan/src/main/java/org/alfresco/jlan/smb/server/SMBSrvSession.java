...
public class SMBSrvSession extends SrvSession implements Runnable {
    ...
    private final PacketHandler m_pktHandler;
    ...
    private final VirtualCircuitList m_vcircuits;

    //  Setup objects used during two stage session setup before the virtual circuit is allocated
    private HashMap<Integer, Object> m_setupObjects;
    ...
    public final boolean hasSetupObject(int pid) {
        ...
        return m_setupObjects.get(pid) != null;
    }
    ...
    public final void setSetupObject(int pid, Object obj) {
        if (m_setupObjects == null) {
            m_setupObjects = new HashMap<>();
        }
        m_setupObjects.put(pid, obj);
    }
    ...
    public final Object removeSetupObject(int pid) {
        ...
        return m_setupObjects.remove(pid);
    }
     ...
     * @throws org.alfresco.jlan.netbios.NetBIOSException
     */
    protected void procNetBIOSSessionRequest() throws IOException, NetBIOSException {
        ...
        StringBuilder nbName = new StringBuilder(32);
        for (int i = 0; i < 32; i++) {
    ...
    protected void procSMBNegotiate() throws SMBSrvException, IOException {
        ...
        boolean extendedSecurity = (m_smbPkt.getFlags2() & SMBSrvPacket.FLG2_EXTENDEDSECURITY) != 0;
     ...
     * @throws java.io.IOException
     * @throws org.alfresco.jlan.smb.server.SMBSrvException
     * @throws org.alfresco.jlan.server.filesys.TooManyConnectionsException
     */
    ...
    protected final synchronized boolean hasAsynchResponse() {
        ...
        return m_asynchQueue != null && (!m_asynchQueue.isEmpty());
    }
    ...
    protected final synchronized SMBSrvPacket removeFirstAsynchResponse() {
        ...
        if (m_asynchQueue == null || m_asynchQueue.isEmpty()) {
            return null;
        }
        //Return the SMB packet from the head of the queue
        SMBSrvPacket pkt = (SMBSrvPacket) m_asynchQueue.remove(0);
        return pkt;
    }
