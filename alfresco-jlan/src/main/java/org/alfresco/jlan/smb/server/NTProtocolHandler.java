...
public class NTProtocolHandler extends CoreProtocolHandler {
     ...
     * @param cmdOff int Offset to the chained command within the request
     * packet.
     ...
     * @throws java.io.IOException
     */
    protected void procTreeConnectAndX(SMBSrvPacket outPkt) throws SMBSrvException, TooManyConnectionsException, java.io.IOException {
     ...
     * @param outPkt SMBSrvPacket
     * @exception java.io.IOException The exception description.
     * @exception SMBSrvException The exception
     */
    @Override
     ...
     * @throws org.alfresco.jlan.smb.server.SMBSrvException
     */
    protected final void procTrans2FindFirst(SrvTransactBuffer tbuf, SMBSrvPacket outPkt) throws java.io.IOException, SMBSrvException {
        //  Get the virtual circuit for the request
        VirtualCircuit vc = m_sess.findVirtualCircuit(m_smbPkt.getUserId());
        if (vc == null) {
            m_sess.sendErrorResponseSMB(SMBStatus.NTInvalidParameter, SMBStatus.DOSInvalidDrive, SMBStatus.ErrDos);
    ...
    protected final void procTrans2QueryPath(SrvTransactBuffer tbuf, SMBSrvPacket outPkt)
        ...
        try {
            ...
            if (streams == false && path.contains(FileOpenParams.StreamSeparator)) {
    ...
    protected final void procNTCreateAndX(SMBSrvPacket outPkt) throws java.io.IOException, SMBSrvException {
        ...
        if (fileName.contains(FileOpenParams.StreamSeparator)) {
