...
public class RpcPacket {
    ...
    /**
     * Build an RPC request header, and set the buffer pointer ready to stream
     * data into the parameter area of the request
     *
     * @param progId int
     * @param verId int
     * @param procId int
    ...
    /**
     * Build a response header for a valid RPC response and set the buffer
     * pointer ready to stream data into the parameter area of the response.
     */
    ...
    /**
     * Build an error response packet where the RPC has been accepted but
     * returns a status code in the parameter area.
     *
     * @param stsCode int
     */
