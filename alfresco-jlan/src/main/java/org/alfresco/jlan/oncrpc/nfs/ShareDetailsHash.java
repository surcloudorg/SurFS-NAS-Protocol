 ...
 *
 * <p>
 * Hashtable of ShareDetails for the available disk shared devices. ShareDetails
 * are indexed using the hash of the share name to allow mounts to be persistent
...
public class ShareDetailsHash {
    ...
    private final HashMap<Integer, ShareDetails> m_details;

    /**
     * Class constructor
     */
    public ShareDetailsHash() {
        m_details = new HashMap<>();
    }
    ...
    public final void addDetails(ShareDetails details) {
        m_details.put(details.getName().hashCode(), details);
    }
    ...
    public final ShareDetails deleteDetails(String shareName) {
        return m_details.get(shareName.hashCode());
    }
    ...
    public final ShareDetails findDetails(String shareName) {
        ...
        ShareDetails details = m_details.get(shareName.hashCode());
    ...
    public final ShareDetails findDetails(int hashCode) {
        //	Get the share details for the associated share name
        ShareDetails details = m_details.get(hashCode);
        //	Return the share details
        return details;
    }
}
