...
public class NFSSrvSession extends SrvSession {
    ...
    /**
     * Add a new connection to the list of active tree connections for this
     * session
     *
    ...
    /**
     * Remove a connection from the list of active tree connections for this
     * session
     *
     * @param tree TreeConnection
     */
